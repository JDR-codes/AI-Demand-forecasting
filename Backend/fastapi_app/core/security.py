...
from fastapi_app.core.config import JWT_SECRET_KEY, JWT_ALGORITHM, ACCESS_TOKEN_EXPIRE_MINUTES
...
def create_access_token(data: dict[str, Any], expires_delta: timedelta | None = None) -> str:
    ...
    unique 'jti' so every issued token can be individually identified/revoked if needed."""
    to_encode = data.copy()
